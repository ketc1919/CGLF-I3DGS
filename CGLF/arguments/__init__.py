...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # regularization for keeping stage-1 anchors compact and local
        self.compact_loss_weight = 0.0
        self.compact_k = 4
        self.compact_target = 0.05
        self.compact_sample_size = 2048
        self.offset_radius_loss_weight = 0.0
        self.offset_radius_target = 0.03

        # optional light-field EPI consistency loss for stage-1
        self.epi_loss_weight = 0.0
        self.epi_loss_interval = 10
        self.epi_num_views = 3
        self.epi_num_lines = 4
        self.epi_axis_mode = "random"
        self.epi_spatial_stride = 1
